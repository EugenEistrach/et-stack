...
>({
	...
	return (
		<div
			ref={wrapperRef}
			className={cn(
				'group border-input bg-background focus-within:ring-ring relative flex flex-col rounded-md border shadow-xs transition-colors focus-within:ring-2 focus-within:ring-offset-2 focus-within:outline-hidden',
				className,
			)}
		>
			{value.length > 0 && (
				<div className="flex flex-wrap gap-1.5 px-2 pt-2">
					{value.map((tag) => (
						...
						>
							...
							<button
								type="button"
								className="ring-offset-background focus:ring-ring ml-1 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden"
			...
			<div className="flex min-h-[36px] w-full items-center px-2 py-1">
				<input
					{...getInputProps({
						...
						className:
							'w-full border-0 bg-transparent p-0 text-sm outline-hidden ring-0 placeholder:text-muted-foreground focus:outline-hidden focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50',
					})}
				/>
			</div>
			{isFocused && (
				<div
					...
					ref={overlayRef}
					className="bg-popover z-50 rounded-md border p-1 shadow-md"
				>
					<div className="max-h-[300px] overflow-auto">
						<div className="text-foreground overflow-hidden py-1">
													...
													>
														<TooltipTrigger asChild>
															<button
																...
																className={cn(
																	'opacity-0 transition-all group-hover:opacity-100 focus:opacity-100',
